...
<body>
    ...
    <div class="container" align="center">
        ...
        <h1><div style="display: inline; cursor: pointer;" id="follow" onclick="bigImg(this)" onmouseout="normalImg(this)">Here is</div> <span id="the">the newest</span> <span class="rabbit_txt" style="font-size: 34px; color:#e84545">Rabbits.</span></h1>
        <br /> <br />
        ...
        <?php       
            ...
            $sql = 'SELECT * from card ORDER BY card_date DESC LIMIT 100';
