...
<body>
    ...
    <div class="container" align="center">
        ...
        <h1><div style="display: inline; cursor: pointer;" id="follow" onclick="bigImg(this)" onmouseout="normalImg(this)">Here is</div> <span id="the">your</span> <span class="rabbit_txt" style="font-size: 34px; color:#e84545">favorites.</span></h1>
        <br /> <br />
        ...
        <?php       
            ...
            $sqlin = "SELECT which_card FROM favorites GROUP BY which_card ORDER BY COUNT(*) DESC";
            $resultin = mysqli_query($conn, $sqlin);
        
            if (mysqli_num_rows($resultin) > 0) {
                while($rowin = mysqli_fetch_assoc($resultin)) {
                    $cardid = $rowin['which_card'];
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '</p>';
                            echo '<div style="position: absolute; left:25%; bottom:0;" align="center"><small><i><b>102</b> peoples like this.</i></small><br />';
